...
class AuditLog(models.Model):
    ...
    class Action(models.TextChoices):
        ...
        ACADEMIC_YEAR_SELECTED = "academic_year_selected", "Sélection d'année scolaire"
        COMMUNICATION_PINNED = "communication_pinned", "Épinglage de communication"
        COMMUNICATION_UNPINNED = "communication_unpinned", "Désépinglage de communication"
        ENTITY_DELETED = "entity_deleted", "Suppression définitive"
        ENTITY_RESTORED = "entity_restored", "Restauration"
        ENTITY_DEACTIVATED = "entity_deactivated", "Désactivation"
        ENTITY_REACTIVATED = "entity_reactivated", "Réactivation"
        FEE_CREATED = "fee_created", "Création de frais"
        FEE_UPDATED = "fee_updated", "Modification de frais"
        FEE_SUBMITTED = "fee_submitted", "Soumission de frais"
        FEE_APPROVED = "fee_approved", "Approbation de frais"
        FEE_REJECTED = "fee_rejected", "Rejet de frais"
        FEE_ARCHIVED = "fee_archived", "Archivage de frais"
        FEE_WITHDRAWN = "fee_withdrawn", "Retrait de demande de frais"
        PAYMENT_RECORDED = "payment_recorded", "Enregistrement de paiement"
        PAYMENT_CANCELLED = "payment_cancelled", "Annulation de paiement"
        RECEIPT_GENERATED = "receipt_generated", "Génération de reçu"
        FINANCE_EXPORTED = "finance_exported", "Export comptable"
        DISCIPLINE_ATTENDANCE_SCANNED = "discipline_attendance_scanned", "Scan de présence (discipline)"
        DISCIPLINE_ATTENDANCE_UPDATED = "discipline_attendance_updated", "Mise à jour de présence (discipline)"
