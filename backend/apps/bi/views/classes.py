...
from apps.bi.services import class_analytics_service

from .base import BiPageView


class ClassesView(BiPageView):
    template_name = "bi/classes/index.html"
    page_title = "Classes"
    ...
    def get_context_data(self, **kwargs):
        ...
        analytics = class_analytics_service.build_class_analytics(year, filters)
        context.update(
            analytics=analytics,
            kpis=analytics["kpis"],
