...
from apps.bi.services import discipline_analytics_service

from .base import BiPageView


class DisciplineAnalyticsView(BiPageView):
    template_name = "bi/discipline/index.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        analytics = discipline_analytics_service.build_discipline_analytics(year, filters)
        context.update(
            analytics=analytics,
            kpis=analytics["kpis"],
